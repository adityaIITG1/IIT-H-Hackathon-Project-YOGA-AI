...
def main():
    ...
    model_path = 'runs/detect/yoga_ai_round2/weights/best.pt'
    
    # Check if we have a trained model, else use pretrained for demo
    if not os.path.exists(model_path):
        print(f"Warning: Custom model not found at {model_path}.")
        print("Using standard yolov8n.pt for demonstration purposes.")
